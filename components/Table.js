...
//   createData('ENV', '2023-06-14', '10:00', 'B01', 'Slipping Off'),
//   createData('TNC', '2023-06-11', '10:00', 'B01', 'Slipping Off'),
//     createData('VGR', '2023-06-16', '10:00', 'B01', 'Slipping Off'),  
// ];
...
export default function EnhancedTable(booking) {
  ...
  const handleClick = (event, vessel) => {
    const selectedIndex = selected.indexOf(vessel);
    let newSelected = [];

    if (selectedIndex === -1) {
      newSelected = newSelected.concat(selected, vessel);
  ...
  const isSelected = (vessel) => selected.indexOf(vessel) !== -1;
